package com.example.android_dev2.instaintegration;
...
/**
 * Created by Android-Dev2 on 11/22/2017.
 */
...
public class RelationShipAdapter extends BaseAdapter {
    ...
    private com.example.android_dev2.lazyload.ImageLoader imageLoader;
    ...
    public RelationShipAdapter(Context context,
        ...
        this.imageLoader = new com.example.android_dev2.lazyload.ImageLoader(context);
    }
